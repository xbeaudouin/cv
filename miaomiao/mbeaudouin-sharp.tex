...
%	\end{fields}
	...
	\story{Office Manager}{Livista Energy Europe S.A.}{Feb 2018 - Aug 2022\\Luxembourg}
	{Office Management\\Administration\\Personnal Assistant}
		...
		\begin{missions}
			...
			\item Ensure offices fitfull employees and visitors
			...
			\item Accounting book of invoices
			\item Invoices, salaries and expenses input into bank system
			\item Filing and archiving contract, proof of payments, ...
			\item Personal administratives tasks for COO
			\item Complex international travel arrangements for COO
		\end{missions}
	}

	\story{Compliance \& Administrative Assistant}{Bank of China Luxembourg S.A.}{Feb 2018 - Aug 2022\\Luxembourg}
	{HO Reporting\\Board preparation}
		{
		\begin{missions}
			\item Monthly \& Quarterly Head Office reporting
			\item Liaise with Legal and Compliance Department's staff members to ensure accurately and timely reporting requirements
			\item Coordination between every Bank's departments on the compliance reporting matters
