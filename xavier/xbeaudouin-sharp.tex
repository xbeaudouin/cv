...
\quote{\itshape 25+ years of Networks \& Opensource Systems Administrator}
...
\begin{document}
	...
	\field{Development}{3}
	\field{Security}{4}
	\field{Project Management}{3}
	\end{fields}


	\section{Skills}
	\begin{skills}{}
	\skill[Systems]{FreeBSD, OpenBSD, Linux, Mac OS X, \st{Windows}}
	\skill[Network]{TCP/IP (IPv4 \& IPv6), Cisco, Juniper, Ubiquiti, Wanguard, Arbor, Mikrotik}
	\skill[Routing Protocols]{BGP, BGP Flowspec, OSPF, ISIS, PIM}
	\skill[SAN/NAS]{ZFS, NetApp, Isilon, Samba, iSCSI, FCP, FCAL, FCoE, Nexenta}
	\skill[LoadBalancers]{nginx, F5 Big/IP, Foundry ServerIron/ADX, Aloha, Relayd}
	\skill[Firewall]{pf, pfSense, opnsense, DynFi, pf, Sophos, ASA}
	\skill[Programming]{Perl, Shell, C, python, HTML, SQL, lua, arduino, git}
	\skill[Virtualization]{bhyve, VMWare ESX, qemu, Veeam, proxmox}
	\skill[Automation]{puppet, saltstack, ansible}
	\skill[Monitoring]{Librenms, Observium, nagios, Centreon, Zabbix}
	\skill[FreeBSD]{Poudriere, BastilleBSD, VNET, jails, bastillebsd}
	\skill[Mail]{postfix, dovecot, amavisd-new, zimbra, ...}
	\end{skills}

	\section{Experiences}
	\story{System Administrator -- Full Remote}{Klara Inc}{Since May 2023\\Canada}
	{FreeBSD\\ZFS\\Poudriere\\Gitlab}
		{
		\begin{missions}
			\item FreeBSD System administration
			\item FreeBSD Security patches
			\item Gitlab Server maintenance on FreeBSD
			\item Networking expertise
			\item Upstreaming FreeBSD patches and ports
		\end{missions}
	}

	\story{Founder}{RIS-LSI}{Since Apr 2023\\Longwy}
	{FreeLance}
		{
		\begin{missions}
			\item BSDs: FreeBSD, OpenBSD, NetBSD
			\item GNU/Linux: Debian, Ubuntu...
			\item Networking: Cisco, Juniper, Mikrotik, Ubiquiti, Wifi
			\item Development: C, Asm, Pike, Python, ...
			\item Energy Storage: Victron Energy
		\end{missions}
	}

	
	\story{Network Engineer -- Full Remote}{SquareFactory}{Oct 2022 - Mar 2023\\Switzerland}
	...
	\skill[IT Hobbies]{RIPE Member, FRnOG "Member", arduino coding, domoticz, home automation}
	\skill[Energy]{Victron Energy Self Professional}
	\end{skills}
